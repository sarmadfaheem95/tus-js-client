...
function encryptData(data) {
  ...
  const PHRASE_ENCRYPTION_DECRYPTION_KEY = 'DO0q.02p@NZgTb321kVxj2,.5C$,dBYz'
	try {
		const cipher = crypto.createCipheriv('aes-256-gcm', PHRASE_ENCRYPTION_DECRYPTION_KEY, iv)
